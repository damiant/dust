...
export const data_dust_events = environment.offline ? '/data/store/' : 'https://api.dust.events/data/'

// Static data is for burning man datasets
export const static_dust_events = environment.offline ? '/data/static/' : 'https://api.dust.events/static/';

// Static content that was generated
export const r2data_dust_events = environment.offline ? '/data/other/' : 'https://data.dust.events/'
